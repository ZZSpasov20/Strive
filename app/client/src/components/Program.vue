...
<template>
    <div class="program-statistics-wrapper">
...
<style scoped>
    ...
    .program-row__icons--green{
        border-color: #71E98A;
    }
    .program-row__icons--yellow{
        border-color: #F8BD00;
    }
    .program-row__icons--red{
        border-color: #FF5F53;
    }
</style>